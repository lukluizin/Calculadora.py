...
b_7 = Button(frame_corpo, command=lambda: entrar_valores('*'), text="*", width=5, height=2, bg=cor5, fg=cor3,font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_11 = Button(frame_corpo, command=lambda: entrar_valores('-'), text="-", width=5, height=2, bg=cor5, fg=cor3,font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_18 = Button(frame_corpo, command= calcular, text="=", width=5, height=2, bg=cor5, fg=cor3,font=('Ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
